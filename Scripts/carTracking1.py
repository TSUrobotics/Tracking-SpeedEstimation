...
# Take first frame and find corners in it (with respect to the detected cars)
cars = []
...
while(True):
    ...
    for car in cars:
        ...
        #for box in nms_boxes_list:
        #    print(box)
        #    cv2.rectangle(img,(box[0],box[1]),(box[0]+box[2],box[0]+box[3]),[int(c) for c in class_colors[0]],1)
